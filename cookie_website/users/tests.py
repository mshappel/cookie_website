...
class TroopTestCase(TestCase):
    def test_ticket_allocation(self):
        ...
        open_time = datetime.datetime(2021, 10, 22, 4, 0, 0, 0, pytz.UTC)
        close_time = datetime.datetime(2021, 10, 22, 14, 0, 0, 0, pytz.UTC)
