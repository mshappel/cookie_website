...
urlpatterns = [
    ...
    # Booths Home
    path('booths/edit_booth/', views.booth_locations, name='booth_locations'),
    # Create New Booth
    ...
    # Edit Booth Hours
    path('booths/edit_booth/<int:booth_id>/hours/', views.edit_location_hours, name='edit_booth_hours'),
    # Delete Booth
