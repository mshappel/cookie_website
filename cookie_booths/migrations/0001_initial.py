    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booth_block_level_restrictions_start', models.SmallIntegerField(choices=[(0, 'None'), (1, 'Daisies'), (2, 'Brownies'), (3, 'Juniors'), (4, 'Cadettes'), (5, 'Seniors'), (6, 'Ambassadors')], default=0)),
                ('booth_block_level_restrictions_end', models.SmallIntegerField(choices=[(0, 'None'), (1, 'Daisies'), (2, 'Brownies'), (3, 'Juniors'), (4, 'Cadettes'), (5, 'Seniors'), (6, 'Ambassadors')], default=0)),
            ...
            options={
                ...
                'permissions': (('booth_loc_creation', 'Creates a booth location'), ('booth_loc_updates', 'Updates a booth location'), ('booth_loc_deletes', 'Deletes a booth location')),
            },
        ),
        migrations.CreateModel(
            name='BoothHours',
            fields=[
                ...
                ('booth_location', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='cookie_booths.boothlocation')),
            ],
        ),
        migrations.CreateModel(
            name='BoothDay',
            fields=[
                ...
                ('booth', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cookie_booths.boothlocation')),
            ],
            options={
                'permissions': (('enable_day', 'Enable a day for a booth'), ('disable_day', 'Disable a day for a booth'), ('add_or_update_hours', 'Add or update hours for a booth day'), ('make_golden_booth', 'Make a booth day golden'), ('enable_freeforall', 'Enable free for all'), ('disable_freeforall', 'Disable free for all')),
            },
        ),
        migrations.CreateModel(
            name='BoothBlock',
            fields=[
                ...
                ('booth_day', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cookie_booths.boothday')),
            ],
            options={
                'permissions': (('cancel_block', 'Cancel a booth'), ('reserve_block', 'Reserve a booth'), ('cancel_block_admin', 'Administrator cancel any booth'), ('reserve_block_admin', 'Administrator reserve any booth')),
            },
        ),
    ]
