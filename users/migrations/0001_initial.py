# Generated by Django 3.2.8 on 2021-12-15 00:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('troop_name', models.CharField(blank=True, max_length=300)),
                ('troop_cookie_coordinator', models.CharField(max_length=300, null=True)),
                ('super_troop', models.BooleanField(default=False)),
                ('troop_level', models.SmallIntegerField(choices=[(1, 'Daisies'), (2, 'Brownies'), (3, 'Juniors'), (4, 'Cadettes'), (5, 'Seniors'), (6, 'Ambassadors')], default=0)),
            ...
            options={
                ...
                'permissions': (('troop_creation', 'Create a troop'), ('troop_updates', 'Updates a troop'), ('troop_deletion', 'Deletes a troop')),
            },
        ),
        migrations.CreateModel(
            name='User',
