...
urlpatterns = [
    ...
    # Edit Booth Hours
    path('edit/<int:booth_id>/hours/', views.edit_booth_location_hours, name='edit_booth_hours'),
    # Delete Booth
    path('confirm_delete/<int:pk>/', views.BoothLocationDelete.as_view(), name='delete_booth'),
    ...
    path('blocks/enable_blocks/<int:block_id>', views.ajax_enable_location_by_block,
         name='ajax_enable_location_by_block'),
    # AJAX Disable Booth by Block
    path('blocks/disable_blocks/<int:block_id>', views.ajax_disable_location_by_block,
    ...
    path('blocks/enable_booth_days/enable', views.enable_location_by_day, name="ajax_enable_day"),
    # AJAX Disable Booth by Day
    path('blocks/enable_booth_days/disable', views.disable_location_by_day, name="ajax_disable_day"),
    #
